...
async def on_member_join(member):
	...
	return await member.guild.get_channel(546592885982887936).send(embed=e)
...
async def on_message_edit(before, after):
	...
	return await before.guild.get_channel(546595428326440982).send(embed=e)
...
async def on_message_delete(message):
	...
	return await message.guild.get_channel(546595428326440982).send(embed=e)
